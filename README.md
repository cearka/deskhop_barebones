## This is a fork of https://github.com/hrvach/deskhop .   Please visit that REPO for all the info and instructions.https://github.com/cearka/deskhop_barebones/blob/main/README.md
